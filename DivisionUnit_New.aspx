...
<asp:Content ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
	...
	<script type="text/javascript" src="../siteassets/scripts/DivisionUnit_New.js"></script> 
        ...
        <div class="row" >
            <div class="col-xs-12">
                <h1 class="h3 pull-left">                    
                    <span >Division Unit Maintenance - New</span>
                </h1>
            </div>
	                    ...
	                    <div class="panel panel-default">
							...
							<div class="form-group">                        
								<span class="control-label col-xs-2">Name</span>
									<div class="col-xs-10"> 
										<input id="txtName" type="text" ng-model="DivUnit.Name" class="form-control " /> 						  
									</div>	
							...
							<div class="form-group">                        
								...
								Abbreviation</span>
									<div class="col-xs-10"> 
										<input id="txtAbb" type="text" ng-model="DivUnit.Abbrv" class="form-control " /> 						  
									</div>	
								<span class="col-xs-2"></span>
									<div class="col-xs-10">                      
							...
							<div class="form-group">                        
								<span class="control-label col-xs-2">Description</span>
									<div class="col-xs-10"> 
										<input id="txtDivDesc" type="text" ng-model="DivUnit.Description" class="form-control " /> 						  
									</div>	
								<span class="col-xs-2"></span>
									<div class="col-xs-10">                      
							...
							<div class="form-group">                        
								<span class="control-label col-xs-2">Levels</span>
									<div class="col-xs-10"> 
										<select id="cboLevel" multiple ng-model="DivUnit.Level" style="width: 100%;height:auto" ng-options="item.LevelDescription as item.LevelDescription for item in LevelLookup" class="chosen form-control " >                                                                                         
										</select>  
									</div>	
								<span class="col-xs-2"></span>
									<div class="col-xs-10">                      
						...
						<div class="panel-body">
							...
							<div class="form-group">                        
								...
								Times to Notify (Before Escalation)</span>
									<div class="col-xs-10"> 
										<input type="number" maxlength="255" ng-model="DivUnit.Notify" min="0" class="txtcurr form-control "/>   
									</div>	
									<span class="col-xs-2"></span>
										<div class="col-xs-10">                      
							...
							<div class="form-group">                        
								...
								Days</span>
									<div class="col-xs-10"> 
										<input type="number" maxlength="255" ng-model="DivUnit.ProcessDays" min="0" class="txtcurr form-control "/>   
									</div>	
									<span class="col-xs-2"></span>
										<div class="col-xs-10">                      
											<p id="" ng-bind="" class="lblErr text-danger"></p>
							...
							<table class="table">
						  		...
						  		<tbody>
								  	<tr ng-repeat="item in Units"> 
								  	  ...
								  	  <td><input id="txtUnit" type="text"  maxlength="255" ng-model="DivUnit.Abbrv" class="form-control" style="width: 250px;" readonly/><p id="UnitErrlbl" class="text-danger" ng-bind="item.UnitErr"></p></td>
									  ...
									  <td><select class="cboUnitAMAO" style="width: auto !important;min-width: 200px;" class="form-control" ></select><p id="UnitAMAOErrlbl" class="text-danger" ng-bind="item.UnitAMAOErr"></p></td>							  
									  <td><select class="cboUnitClearingOfficer" style="width: auto !important;min-width: 200px;" class="form-control"></select><p id="UnitClearingOfficerErrlbl" class="text-danger" ng-bind="item.UnitClearingOfficerErr"></p></td>
									  <td><select class="cboUnitAlternateOfficer" style="width: auto !important;min-width: 200px;" class="form-control"></select><p id="UnitAlternateOfficerErrlbl" class="text-danger" ng-bind="item.UnitAlternateOfficerErr"></p></td>
									  <td><select class="cboUnitEscalationOfficer" style="width: auto !important;min-width: 200px;" class="form-control" ></select><p id="UnitEscalationOfficerErrlbl" class="text-danger" ng-bind="item.UnitEscalationOfficerErr"></p></td>
									  <td><input type="number" ng-model ="item.Notify" maxlength="255" min="0" style="width: 250px;" class="txtcurr form-control"/></td>
									  <td><input id="txtProcessDays" type="number" maxlength="255" min="0" ng-model ="item.ProcessDays" style="width: 250px;" class="txtcurr form-control"/></td>										  	   
								  	</tr>							
								</tbody>											
				             </table>
